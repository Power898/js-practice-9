 ...
 */
function findElementGreaterThan(arr, num) {if (Array.isArray(arr)===false){return `undefined`;} 
else if(arr.find(element =>element>num)===undefined){return ` Числа яке задовільняе умову не знайдено`;}
else{return arr.find(element=>element>num);}
 ...
 */
function findIndexByProperty(arr, name) {if (Array.isArray(arr)===false){return  -1;} const foundIndex= arr.findIndex((obj)=> obj.name === name);
return foundIndex >= 0 ? foundIndex : "Об'єкта з таким індексом не знайдено";
} 
 ...
 */
function findLastEvenNumber(arr) {if (Array.isArray(arr)===false){return `Вхідний параметр має бути масивом`;} 
const LastNumber = arr.findLast((element)=> element % 2 === 0); return LastNumber > 0 ? LastNumber : "Парних чисел не знайдено";
 ...
 */
function getSubArrayAndConvertToString(arr, startIdx) { if (Array.isArray(arr)===false){return `Вхідний параметр має бути масивом`;} 
const Copi=arr.slice(startIdx); console.log(Copi.join());
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні повертаємо 'Вхідний параметр має бути масивом'
 ...
 */
function getArrayKeys(arr) {if (Array.isArray(arr)===false){return `Вхідний параметр має бути масивом`;}
const iterator=arr.keys(); for( const key of iterator){console.log(key)};
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні повертаємо 'Вхідний параметр має бути масивом'
 ...
 */
function getPositiveArrayValues(arr) { if (Array.isArray(arr)===false){return `Вхідний параметр має бути масивом`;} 
const arrayValuesIterator=arr.values();
const arrayValues= Array.from(arrayValuesIterator);
const positiveArrayValues=arrayValues.filter((value)=>value>0); return positiveArrayValues;
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні повертаємо 'Вхідний параметр має бути масивом'
 ...
 */
function removeAndDouble(arr, startIdx) {if(!Array.isArray(arr)){ return 'Вхідний параметр має бути масивом' ;} 
const arr1=arr.slice(startIdx); const arr2=arr1.map(x=>x*2); return arr2;
 ...
 */
function sumAndPrint(arr) {if(!Array.isArray(arr)){ return 'Вхідний параметр має бути масивом' ;} 
const initialValue = 0;
const SumWithInitial = arr.reduce((accumulator, currentValue)=>accumulator+currentValue, initialValue);
const ElementSee = arr.forEach(element=>console.log(element));
 ...
 */
function flattenSquareAndFilter(arr, threshold) {if(!Array.isArray(arr)){ return 'Вхідний параметр має бути масивом' ;} 
const initialValue = 0;
const SumWithInitial = arr.reduce((accumulator, currentValue)=>accumulator+currentValue, initialValue);
const ElementSee = arr.forEach(element=>console.log(element));
return SumWithInitial;
 ...
 */
function getLastElementsSumAndPrint(arr, n) {if(!Array.isArray(arr)){ return 'Вхідний параметр має бути масивом' ;}
 const arr1 = arr.slice(n); const arr2=arr1.reduceRight((accumulator,currentValue)=>accumulator+currentValue);
 const arr3=arr1.forEach(element=>console.log(element)); return arr3,arr2;
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні повертаємо 'Вхідний параметр має бути масивом'
 ...
 */
function wordLengths(arr) {if(!Array.isArray(arr)){ return 'Вхідний параметр має бути масивом' ;}
 const arr1=arr.map(word=>word.length); return arr1;
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні, повертаємо 'Вхідний параметр має бути масивом'
 ...
 */
function insertElementAt(arr, index, element) {if(!Array.isArray(arr)){ return 'Вхідний параметр має бути масивом' ;} 
const arr1=arr.splice(index, element); return arr1;
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні повертаємо 'Вхідний параметр має бути масивом'
 ...
 */
function flattenArray(arr) {if(!Array.isArray(arr)){ return 'Вхідний параметр має бути масивом' ;} 
 const arr1=arr.flat(Infinity); return arr1;
 ...
 */
function expandArrayByN(arr, n) {if(!Array.isArray(arr)){ return 'Вхідний параметр має бути масивом' ;} 
const arr1=arr.flatMap((num)=>Array(n).fill(num)); return arr1;
...
/**
  ...
  */
function findLongestWord(arr) { if(!Array.isArray(arr)){ return [] ;} const LongestWorld = arr.reduce((a, b) => (b.length > a.length) ? b : a); 
return LongestWorld;
...
*/
function findDuplicateElements(arr) {if(!Array.isArray(arr)){ return [] ;} 
...
*/
function capitalizeWords(arr) { if(!Array.isArray(arr)){ return [] ;} const capitalizedArray= arr.map((word)=>{const capitalizeWords=word.charAt(0).toUpperCase()+word.slice(1);
  return capitalizeWords;}); return capitalizedArray;
...
/**
  ...
  */
function calculateTotalPrice(arr) { if(!Array.isArray(arr)){ return 0 ;}  const initialValue= 0;
const ZugSum=arr.reduce((accumulator, currentValue)=> accumulator + currentValue.price, initialValue); return ZugSum;
...
*/
function findLastNegativeNumberIndex(arr) {if(!Array.isArray(arr)){ return -1 ;} 
const arr1= arr.findLastIndex((element)=>element<0); return arr1; 
